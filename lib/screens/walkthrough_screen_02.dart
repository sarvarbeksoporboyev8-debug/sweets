...
class WalkthroughScreen02 extends StatelessWidget {
        ...
        child: Column(
          children: [
                      ...
                      child: Stack(
                        children: [
                          Positioned(
                            left: 0,
                            top: 0,
                            child: Image.asset('images/figma/b5d6cff7-5424-491b-8b9c-30f375135b73.png',
                              width: 300,
                              height: 607,
                              fit: BoxFit.cover,
                          ...
                          Positioned(
                            left: 14.88,
                            top: 12.79,
                            child: Image.asset('images/figma/fcaf9cd2-e6b3-4313-bc4a-48777a84a633.png',
                              width: 268.155,
                              height: 579.315,
                              fit: BoxFit.cover,
                              errorBuilder: (context, error, stackTrace) {
            ...
            SizedBox(
              width: 387,
              child: Text(
                'Discover the most delicious sweets',
            ...
            SizedBox(
              width: 388,
              child: Text(
                'Explore the catalog of delectable sweets, desserts, chocolates, and more. Search for new flavors.',
            ...
            SizedBox(
              width: 56,
              height: 8,
              child: Image.asset('images/figma/49aeb76a-bddb-4205-8ea4-4372d888daef.png',
                fit: BoxFit.contain,
                errorBuilder: (context, error, stackTrace) {
                  return Row(
